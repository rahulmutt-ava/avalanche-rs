...
**Crate:** ava-wallet  ·  **Depends on:** M4 ava-platformvm (tx/UTXO/Owner/SubnetValidator types), M1 ava-crypto (keychain, secp256k1, BLS PoP)  ·  **Spec:** 12 §13
