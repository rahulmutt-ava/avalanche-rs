...
### Task M2.11: `PeerConfig` + Network/Inbound/External traits + version Compatibility wiring
...
### Task M2.12: outbound `MessageQueue` + outbound byte throttler
...
### Task M2.13: inbound byte throttler + inbound-conn-upgrade throttler
...
### Task M2.20: network metrics + Connect-service enumeration note (R5)
...
### Task M2.21: `prop::handshake_reaches_connected` (in-process duplex)
