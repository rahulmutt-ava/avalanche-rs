...
### Task M9.19: `test-reexecute` — replay recorded mainnet ranges → state roots match Go 🟡 C + X + P-CHAIN LEGS DONE (C 2026-06-15, X 2026-06-16c, P 2026-06-16d — determinism floor); height≥1 P-Chain accept + Go-`blockexport` parity deferred
