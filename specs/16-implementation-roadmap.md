...
| **T5 — Node/APIs** | `ava-api`, `ava-indexer`, `ava-wallet`, `ava-genesis`, `ava-config`, `ava-node`, `avalanchers` (bin) | `12`, `13`, `14` | T4 (all chains), T2/T3 (handlers) | (flag/API/genesis parity) |
...
1. **Joins Mainnet & Fuji.** A Rust `avalanchers` boots against Mainnet and Fuji
